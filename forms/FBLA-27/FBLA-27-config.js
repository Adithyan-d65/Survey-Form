// FBLA-27-config.js — Survey Form System 2027
// Template config for FBLA-27
// ⚠️  DO NOT EDIT the shared sections (US_STATES, OPTS).
//     Only edit the questions array in FORM_CONFIGS.FBLA below.
...
window.FORM_CONFIGS = {
  ...
  // ── FBLA (SO) ── Q nums: 1-5 partner, 6-20 ───────────────────────────────
  FBLA: {
    displayName: "FBLA-27",
    surveyType: "SO",
    questions: [
      { qNum: "1", key: "PartnerDefinedFieldFour", type: "radio", opts: OPTS.AE, label: "How long have you been a member of FBLA? (Darken ONE)" },
      { qNum: "2", key: "PartnerDefinedFieldFive", type: "checkbox", opts: OPTS.FBLA_P2, label: "Which of the following FBLA experiences have you participated in? (Darken as many as apply)" },
      { qNum: "3", key: "PartnerDefinedFieldSix", type: "checkbox", opts: OPTS.FBLA_P3, label: "FBLA has helped me develop the following transferable skills. (Darken as many as apply)" },
      { qNum: "4", key: "PartnerDefinedFieldSeven", type: "radio", opts: OPTS.AE, label: "Through FBLA, I have applied what I learned in the classroom to real-world situations. (Darken ONE)" },
      { qNum: "5", key: "PartnerDefinedFieldEight", type: "radio", opts: OPTS.FBLA_P5, label: "If you did not participate in FBLA programs this year, what was the main reason? (Darken ONE)" },
      ...
      { qNum: "14", key: "_collegeVisits", type: "collegeVisits", prefix: "14", max: 4 },
...
window.getFormConfig = function (t) { return FORM_CONFIGS[t] || FORM_CONFIGS.FBLA; };
