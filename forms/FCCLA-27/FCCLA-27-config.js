...
window.FORM_CONFIGS = {
  ...
  FCCLA: {
    ...
    questions:[
      ...
      { qNum:"16A", key:"ActivityA", type:"checkbox", opts:OPTS.ACTIVITY, label:"(All that apply)" },
      { qNum:"16B", key:"ActivityB", type:"checkbox", opts:OPTS.ACTIVITY, label:"(All that apply)" },
