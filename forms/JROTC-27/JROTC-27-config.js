// JROTC-27-config.js — Survey Form System 2027
// Template config for JROTC-27
// ⚠️  DO NOT EDIT the shared sections (US_STATES, OPTS).
//     Only edit the questions array in FORM_CONFIGS.JROTC below.
...
window.FORM_CONFIGS = {
  ...
  // ── JROTC (SR) ── Q nums: 1-4,6 partner, 5 MPlanInfo, 7-21 ──────────────
  JROTC: {
    displayName: "JROTC-27",
    surveyType: "SR",
    questions: [
      { qNum: "1", key: "PartnerDefinedFieldFour", type: "radio", opts: OPTS.JROTC_P1, label: "In your experience, what is the primary reason students do not stay in JROTC for the full 4 years in high school? (Darken ONE)" },
      { qNum: "2", key: "PartnerDefinedFieldFive", type: "checkbox", opts: OPTS.JROTC_P2, label: "In which JROTC Branch do you participate? (Darken as many as apply)" },
      { qNum: "3", key: "PartnerDefinedFieldSix", type: "checkbox", opts: OPTS.JROTC_P3, label: "In which of the following types of ROTC scholarships are you interested? (Darken as many as apply)" },
      { qNum: "4", key: "PartnerDefinedFieldSeven", type: "checkbox", opts: OPTS.JROTC_P4, label: "Which of the following skills does JROTC help you develop? (Darken as many as apply)" },
      { qNum: "5", key: "MPlanInfo", type: "checkbox", opts: OPTS.MPLANINFO, label: "(All that apply)" },
      { qNum: "6", key: "PartnerDefinedFieldEight", type: "checkbox", opts: OPTS.JROTC_P6, label: "If you are considering military service in your future, which service group/branch would you prefer to join? (Darken as many as apply)" },
...
window.getFormConfig = function (t) { return FORM_CONFIGS[t] || FORM_CONFIGS.JROTC; };
